...
const Card = () => {
  ...
  const handleInc = (id) => {
    const updateCart = product.map((item) => {
      if (item.id === id) {
        return {
          ...item,
  ...
  return (
    <div className="container mx-auto mt-10">
      <div className="mx-auto flex flex-wrap p-5 flex-col md:flex-row  shadow-md my-10">
        <div className="w-3/4 md:w-1/2 w-5/6 bg-white px-10 py-10">
            ...
            <>
              <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                <div className="flex w-2/5">
                  <div className="w-20">
                    <img className="h-24" src={c.image} alt="" />
                  </div>
                  <div className="flex flex-col justify-between ml-4 flex-grow">
                    <span className="font-bold text-sm">{c.title}</span>
                    <span className="text-red-500 text-xs">{c.category}</span>
                    <a
        ...
        <div id="summary" className="w-1/4 px-8 py-10 md:w-1/2 w-5/6">
